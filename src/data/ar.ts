...
export const arSentences: SentenceItem[] = [
  {
    id: 1,
    name: "Hello",
    language: "ar",
  ...
  },
  {
    ...
    phonetic: "ana la afham",
  },
  {
    id: 13,
    name: "Do you take credit cards?",
    language: "ar",
    sentence: "هل تقبلون بطاقات الائتمان؟",
    phonetic: "hal taqbalon bitaqat aleitmian?",
  },
  {
    id: 14,
    name: "I need go to hospital",
    language: "ar",
    sentence: "أحتاج الذهاب إلى المستشفى.",
    phonetic: "ahtaj aldhahab 'iilaa almustashfa",
  },
  {
    id: 15,
    name: "Is there free wifi available?",
    language: "ar",
    sentence: "هل هناك واي فاي مجاني متاح؟",
    phonetic: "hal hunak way fay mujani mutah?",
  },
  {
    id: 16,
    name: "Which one do you recommend?",
    language: "ar",
    sentence: "أي واحد توصي به؟",
    phonetic: "ay wahid tawsi bih?",
  },
  {
    id: 17,
    name: "Can it be cheaper?",
    language: "ar",
    sentence: "هل يمكن أن يكون أرخص؟",
    phonetic: "hal yumkin 'an yakun 'arkhas?",
  },
  {
    id: 18,
    name: "Could can take a picture for me?",
    language: "ar",
    sentence: "هل يمكنك التقاط صورة لي؟",
    phonetic: "hal yumkinuk alttakat suwarat li?",
  },
  {
    id: 19,
    name: "I am allergic to peanuts.",
    language: "ar",
    sentence: "أنا أعاني من حساسية تجاه الفول السوداني.",
    phonetic: "ana 'aani min husasiat tijah alful alsudani",
  },
  {
    id: 20,
    name: "I don't eat spicy food.",
    language: "ar",
    sentence: "أنا لا أكل الطعام الحار.",
    phonetic: "ana la 'akul alti'am alhar",
  },
];
